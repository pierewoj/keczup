...
void initializeGlobalVariables(void)
{
	...
	controllerForward.diffInterval = 3;
	...
	controllerLeftKtir.diffInterval = 2;

	controllerRightKtir.enabledP = 1;
	controllerRightKtir.enabledI = 1;
	...
	controllerRightKtir.diffInterval = 2;
