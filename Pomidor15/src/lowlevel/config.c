...
void GPIO_Config(void)
{
        ...
        //PA6, PA7 - ultrasonic sensors echo
        ...
        GPIO_InitStructure.GPIO_Pin =  GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_4 | GPIO_Pin_5 | GPIO_Pin_11 | GPIO_Pin_12 | GPIO_Pin_15 ;
        GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
        GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
       	GPIO_Init(GPIOA, &GPIO_InitStructure);

        //KTIRs B3/B4/B5/B12/B13/B14
       	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3 | GPIO_Pin_4 | GPIO_Pin_5 | GPIO_Pin_12 | GPIO_Pin_13 | GPIO_Pin_14;
       	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
       	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
        GPIO_Init(GPIOB, &GPIO_InitStructure);

        //KTIRs C2/C3/C4/C5/C14/C15
       	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2 | GPIO_Pin_3 | GPIO_Pin_4 | GPIO_Pin_5 | GPIO_Pin_14 | GPIO_Pin_15;
       	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
       	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
        GPIO_Init(GPIOC, &GPIO_InitStructure);
...
void TIMERs_Config(void)
{
		...
		TIM3->CCMR2 |= TIM_CCMR2_IC3F_0 | TIM_CCMR2_IC3F_1 | TIM_CCMR2_IC4F_0 | TIM_CCMR2_IC4F_1;
...
void USART_Config()
{
        ...
        USART_InitStructure.USART_BaudRate = 1000000;//19200;
...
void DMA_Config(void)
{
	...
	DMA1_Channel7->CCR |= DMA_CCR7_MSIZE_0  | DMA_CCR7_TCIE  | DMA_CCR7_MINC  | DMA_CCR7_PSIZE_0 | DMA_CCR7_DIR | DMA_CCR7_PL_1;
...
void ADC_Config(volatile unsigned int *tab)
{
	...
	DMA1_Channel1->CCR |= DMA_CCR1_MSIZE_1  | DMA_CCR1_CIRC  | DMA_CCR1_MINC  | DMA_CCR1_PSIZE_0;
...
void gyro_config(void)
{
	...
	for (a = 0 ; a < gyro_calibration_sample_number ; a++)
	{
		...
		gyro_initial_values[0] += (int16_t)(dane_z_imu[1]<<8 | dane_z_imu[0]);
		gyro_initial_values[1] += (int16_t)(dane_z_imu[3]<<8 | dane_z_imu[2]);
		gyro_initial_values[2] += (int16_t)(dane_z_imu[5]<<8 | dane_z_imu[4]);
	}
