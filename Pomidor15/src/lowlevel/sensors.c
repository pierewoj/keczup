...
void read_ktirs(){   // !!! jeszcze nie ustalone piny !!!!
	ktirFront[0] = (unsigned short int) GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_5);
	ktirFront[1] = (unsigned short int) GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_5);
	ktirFront[2] = (unsigned short int) GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_5);
	ktirFront[3] = (unsigned short int) GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_4);
	ktirFront[4] = (unsigned short int) GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_13);
	ktirFront[5] = (unsigned short int) GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_15);
	ktirFront[6] = (unsigned short int) GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_14);


	ktirLeft[0] = (unsigned short int) GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_2);
	ktirLeft[1] = (unsigned short int) GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_11);
	ktirLeft[2] = (unsigned short int) GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_11);
	...
	ktirRight[0] = (unsigned short int) GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_12);
	ktirRight[1] = (unsigned short int) GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_15);
	ktirRight[2] = (unsigned short int) GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_12);
...
void encodersRead (void)
{
	...
	//predkosci w mm/s
	V_L=leftCount*IMP_DIST*(1000./((double)(time - time_old)));
	V_R=rightCount*IMP_DIST*(1000./((double)(time - time_old)));
	time_old = time;
	...
	dist_L=leftTotal*IMP_DIST;
	dist_R=rightTotal*IMP_DIST;
}
